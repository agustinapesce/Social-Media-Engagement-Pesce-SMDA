...
inputfiledir = 'allSets_trim.csv' #input("data file directory: ") #"C:/Users/Julian/GDrive/1 Twitter Project/Julian/MEC/M-E-P-N_encoding/without_emoji/tweet_in.csv"
tw_content_indx = 0 #int(input("tweet text index in input file (10 for summer data, 7 for latest, 4 for processed): "))
print("\n")
...
outdoc= csv.writer(open("allSets_encoded.csv", mode = "w", encoding = "utf-8"), lineterminator ="\n")
